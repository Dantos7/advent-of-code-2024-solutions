...
def first_part(instance: InstanceType, day: str) -> int:
    ...
    for trailhead in trailheads:
        compute_ascending_paths(matrix, trailhead, [])
...
def compute_ascending_paths(matrix: list[list[int]], trailhead: tuple[int, int], preceding_path: list[tuple[int,int]]) -> list[list[tuple[int,int]]]:
